    ...
    def expand_query(self, query: str) -> str:
        ...
        if query_length < self.min_words:
            ...
            system_prompt = (
                "You are a helpful assistant specialized in MicroStep-MIS documentation. "
                "MicroStep-MIS develops and manufactures customized monitoring and information systems for environmental monitoring, "
                "including aviation, road weather, and marine systems. The user's query is too long! "
                "Please compress or summarize it while preserving its core meaning and ensuring the summary aligns with the context of MicroStep-MIS documentation. "
